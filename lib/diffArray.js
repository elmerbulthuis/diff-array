			...
			*/
			if(fromValue === toValue){
				...
				*/
				...
				if(!(fromValue in toMap) || toMap[fromValue].reduce(function(previous, current){
					return toIndex > current && previous;
				}, true)){
					result.push({
						type: 'delete'
						, index: toIndex
				...
				*/
				...
				if(!(toValue in fromMap) || fromMap[toValue].reduce(function(previous, current){
					return fromIndex > current && previous;
				}, true)){
					result.push({
						type: 'insert'
